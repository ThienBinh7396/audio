...
export default {
    ...
    methods: {
        ...mapMutations('app', ['setNav', 'setTitle']),
        ...
        speak: function () {
            ...
            let Url = `https://texttospeech.responsivevoice.org/v1/text:synthesize?text=${this.storyInfo.content[this.currentLine]}&lang=vi&engine=g1&rate=0.65&volume=1&key=32hDX4HJ&gender=female`
